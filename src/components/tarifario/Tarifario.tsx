...
const Tarifario: React.FC<Props> = ({ multa }) => {
  return (
    <div className="w-full rounded-lg p-4 border-[1px] border-gray-200 bg-white dark:bg-[#444] flex flex-col gap-2 dark:border-[#444]">
      <span className="text-lg font-semibold dark:text-[whitesmoke]">{multa.reason}</span>
